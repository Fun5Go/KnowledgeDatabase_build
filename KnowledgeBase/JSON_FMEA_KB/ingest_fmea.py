from KnowledgeBase.JSON_FMEA_KB.kb_structure import FMEAFailureKB, FileMeta, FileMetaStore, FailureEntity, FailureSemanticNode, Sentence, SentenceKB
from KnowledgeBase.JSON_FMEA_KB.sentence_builder import _build_full_chain_sentence
import json
