...
JSONL_PATH= Path(r"C:\Users\FW\Desktop\FMEA_AI\Project_Phase\DATA\JSON\FMEA_motor_drive_recall_PT_MC.jsonl")
# Persist KB data folders
KB_DATA_ROOT = BASE_DIR.parent/ "KB_motor_drives_allPT_MC"
