...
- connected_chunk_groups may be used only as context for how chunks relate.
...
- label must copy candidate "label".
- name must copy candidate "name".
- raw_text must copy candidate "text" exactly.
